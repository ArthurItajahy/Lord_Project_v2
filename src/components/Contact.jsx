...
import GandalfCanvas from "./canvas/Final"
        ...
        >
          <label className='flex flex-col'>
            ...
            <input
              ...
              className='bg-[#1F2D1F] py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
          ...
          <button
            type='submit'
            className='bg-[#1F2D1F] py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-primary'
          >
